...
<div class="mb-6 p-4 bg-darkBg rounded-lg border border-gold/10">
    <div class="grid sm:grid-cols-2 gap-6">
        {{-- Style Selector --}}
        <div>
            <label class="text-light font-semibold mb-3 block text-sm">{{ __($t . '.cursed_style') }}</label>
            <select id="cursed-style" class="w-full bg-darkBg border border-gold/20 rounded-lg p-2.5 text-sm text-light focus:border-gold focus:outline-none focus:ring-1 focus:ring-gold/30 cursor-pointer">
                <option value="creepy">{{ __($t . '.style_creepy') }}</option>
                <option value="demonic">{{ __($t . '.style_demonic') }}</option>
                <option value="glitch">{{ __($t . '.style_glitch') }}</option>
                <option value="ancient">{{ __($t . '.style_ancient') }}</option>
                <option value="void">{{ __($t . '.style_void') }}</option>
            </select>
        </div>
        {{-- Intensity --}}
        <div>
