<x-layout>
    ...
    (function() {
        ...
        function buildBreakdown(dec, oct) {
            const n = parseInt(dec, 10);
            if (n === 0) {
                return `<div class="text-light-muted">0 &divide; 8 = 0 remainder <span class="text-gold font-bold">0</span></div>
                         <div class="mt-2 pt-2 border-t border-gold/10 text-light">Result: <span class="text-gold font-bold">0</span></div>`;
            }
            ...
            let html = `<div class="overflow-x-auto"><table class="w-full text-sm">
                <thead><tr class="text-light-muted border-b border-gold/10">
                    ...
                    <th class="text-left py-2 px-3">Quotient</th>
                    <th class="text-left py-2 px-3">Remainder</th>
                </tr></thead><tbody>`;
            ...
            html += `<div class="mt-3 pt-2 border-t border-gold/10 text-light text-sm">
                Read remainders bottom &rarr; top: <span class="text-gold font-bold">${oct}</span>
            </div>`;
        ...
        function swapDirection() {
            ...
            if (isDecimalToOctal) {
                directionLabel.innerHTML = '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg> Decimal &rarr; Octal';
                ...
                directionLabel.innerHTML = '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 17l-5-5m0 0l5-5m-5 5h12"></path></svg> Octal &rarr; Decimal';
        ...
        btnSample.addEventListener('click', function() {
            inputEl.value = isDecimalToOctal ? '125, 255, 493, 511' : '175, 377, 755, 777';
            outputEl.value = '';
            breakdown.classList.add('hidden');
            convert();
        });
