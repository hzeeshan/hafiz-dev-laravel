...
<div class="mb-6 p-4 bg-darkBg rounded-lg border border-gold/10">
    <div class="flex flex-wrap gap-4">
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.reverse_characters') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.reverse_words') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.reverse_each_word') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.reverse_line_order') }}</span>
        </label>
    </div>
</div>
...
<div id="stats-bar" class="hidden bg-darkBg rounded-lg p-4 border border-gold/10">
    <div class="grid grid-cols-4 gap-4">
        ...
        <div class="text-center">
            ...
            <div class="text-light-muted text-sm">{{ __($t . '.mode') }}</div>
        </div>
    </div>
</div>
