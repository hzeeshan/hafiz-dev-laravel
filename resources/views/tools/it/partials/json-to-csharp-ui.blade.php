...
<div class="mb-6 p-4 bg-darkBg rounded-lg border border-gold/10">
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
        ...
        <div>
            <label for="collection-type" class="text-light font-semibold mb-2 block text-sm">{{ __($t . '.collection_type') }}</label>
        ...
        <div>
            <label for="json-lib" class="text-light font-semibold mb-2 block text-sm">{{ __($t . '.json_library') }}</label>
            <select id="json-lib" class="w-full bg-darkCard border border-gold/20 rounded-lg px-3 py-2 text-light text-sm focus:border-gold/50 focus:outline-none cursor-pointer">
                <option value="none">{{ __($t . '.json_lib_none') }}</option>
    ...
    <div class="flex flex-wrap gap-6">
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.nullable_types') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.public_classes') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.get_set') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.wrap_namespace') }}</span>
        </label>
    </div>
</div>
...
<div class="grid lg:grid-cols-2 gap-4 mb-6">
    ...
    <div class="flex flex-col">
        ...
        <textarea
            ...
            placeholder="{{ __($t . '.csharp_output_placeholder') }}"
            readonly
        ></textarea>
    </div>
</div>
