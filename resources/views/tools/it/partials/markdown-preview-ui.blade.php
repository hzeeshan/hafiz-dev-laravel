...
<div class="focus-toolbar flex flex-wrap items-center gap-2 mb-4">
    ...
    <div class="flex items-center gap-2">
        ...
        <button id="btn-focus" class="px-3 py-1.5 bg-gold/10 border border-gold/50 text-gold rounded-lg hover:bg-gold/20 transition-all duration-300 flex items-center gap-2 text-sm cursor-pointer" title="{{ __($t . '.focus_title') }}">
            ...
            <span id="focus-label">{{ __($t . '.focus') }}</span>
        </button>
    </div>
</div>
