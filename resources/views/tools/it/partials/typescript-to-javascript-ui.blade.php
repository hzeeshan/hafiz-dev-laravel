...
<div class="mb-6 p-4 bg-darkBg rounded-lg border border-gold/10">
    <div class="flex flex-wrap gap-6">
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.preserve_comments') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.remove_modifiers') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.remove_import_types') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.convert_enums') }}</span>
        </label>
    </div>
</div>
...
<div id="stats-bar" class="hidden bg-darkBg rounded-lg p-4 border border-gold/10">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="text-center">
            ...
            <div class="text-light-muted text-sm">{{ __($t . '.stat_types') }}</div>
        </div>
        <div class="text-center">
            <div id="stat-interfaces" class="text-2xl font-bold text-light mb-1">0</div>
            <div class="text-light-muted text-sm">{{ __($t . '.stat_interfaces') }}</div>
        </div>
        <div class="text-center">
            <div id="stat-reduction" class="text-2xl font-bold text-light mb-1">0%</div>
            <div class="text-light-muted text-sm">{{ __($t . '.stat_reduction') }}</div>
        </div>
    </div>
</div>
