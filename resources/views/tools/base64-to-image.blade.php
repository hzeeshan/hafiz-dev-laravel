<x-layout>
    ...
    (function() {
        ...
        function convert() {
            ...
            if (!input) { showError('Please paste a Base64 string'); return; }
            ...
            previewImg.onload = function() {
                ...
                showSuccess('Image decoded — ' + this.naturalWidth + '×' + this.naturalHeight + ' ' + currentFormat.toUpperCase());
            };
            previewImg.onerror = function() {
                showError('Could not decode image. The Base64 data may be corrupted or not a valid image.');
        ...
        b64Input.addEventListener('input', function() {
            ...
            inputLength.textContent = len.toLocaleString() + ' character' + (len !== 1 ? 's' : '');
        });
        ...
        btnDownload.addEventListener('click', function() {
            ...
            showSuccess('Image downloaded as image.' + currentFormat);
        });

        btnSample.addEventListener('click', function() {
            b64Input.value = sampleBase64;
            inputLength.textContent = sampleBase64.length.toLocaleString() + ' characters';
            convert();
        });
        ...
        btnClear.addEventListener('click', function() {
            ...
            currentDataUri = '';
            inputLength.textContent = '0 characters';
            successNotification.classList.add('hidden');
            errorNotification.classList.add('hidden');
        });
