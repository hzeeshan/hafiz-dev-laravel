    ...
    app: my-app"
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <a href="/tools/json-to-yaml" class="bg-gradient-card p-4 rounded-lg border border-gold/20 hover:border-gold/50 transition-colors text-center group">
                        <span class="text-2xl mb-2 block">🔄</span>
                        <span class="text-light text-sm group-hover:text-gold transition-colors">JSON to YAML</span>
                    </a>
                    <a href="/tools/xml-to-json" class="bg-gradient-card p-4 rounded-lg border border-gold/20 hover:border-gold/50 transition-colors text-center group">
                        <span class="text-2xl mb-2 block">📄</span>
                        <span class="text-light text-sm group-hover:text-gold transition-colors">XML to JSON</span>
                    </a>
