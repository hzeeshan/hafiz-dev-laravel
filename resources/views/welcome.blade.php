    ...
    <div class="relative z-10">
        ...
        <section class="min-h-screen flex items-center justify-center px-4 pt-4 pb-20" id="home">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-light mb-5 leading-tight">
                    Laravel • Vue.js • Process Automation
                </h1>

                <div class="text-base md:text-lg text-light-muted max-w-2xl mx-auto mb-2 leading-relaxed space-y-3">
                    <p>
                        I'm Hafiz, a Full Stack Developer from Torino, Italy. I specialize in building web applications
                        with PHP, Laravel, Vue.js, and automating business processes that save companies hours of manual
                        work.
                    </p>
                    <p>
                        I've launched my own SaaS products and worked with dozens of businesses, so I understand both
                        the technical challenges and business needs. Whether it's eliminating repetitive tasks or
                        building something from scratch, I focus on creating solutions that actually work.
                    </p>
                ...
                <div class="flex items-center justify-center my-3">
                    <div class="h-px w-16 bg-gradient-to-r from-transparent via-gold/40 to-transparent"></div>
                    <div class="mx-4 text-gold">◆</div>
                    <div class="h-px w-16 bg-gradient-to-r from-transparent via-gold/40 to-transparent"></div>
                </div>
        ...
        <section class="py-20 px-4" id="services">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <!-- Service 1 -->
                    <div
                        class="bg-gradient-card p-6 rounded-xl border border-gold/20 shadow-dark-card hover:shadow-dark-card-hover transition-all duration-300 hover:-translate-y-1">
                        ...
                        <p class="text-light-muted text-sm leading-relaxed">
                            Save 10-20 hours weekly by automating repetitive tasks. Custom automation solutions tailored
                    ...
                    <div
                        ...
                        <p class="text-light-muted text-sm leading-relaxed">
                            From idea to profitable product. Complete SaaS development including user management,
                            payment processing, and scaling.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-light-muted text-sm leading-relaxed">
                            Building robust full-stack applications with Laravel, Filament, and Livewire for scalable
                            web solutions.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-light-muted text-sm leading-relaxed">
                            Add intelligent automation to your applications. Content generation, data analysis, and
                            AI-powered features.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-light-muted text-sm leading-relaxed">
                            Creating interactive user interfaces with Vue.js, Inertia.js, and modern frontend
                            technologies.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-light-muted text-sm leading-relaxed">
                            Build powerful browser extensions that enhance productivity and streamline workflows for
                            businesses.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+393888255329"
                                        class="text-light-muted hover:text-gold transition-colors">(+39) 3888255329</a>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="https://hafiz.dev"
                                        class="text-light-muted hover:text-gold transition-colors">hafiz.dev</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-card p-8 rounded-xl border border-gold/20 shadow-dark-card">
                        ...
                        <p class="text-light-muted mb-6 leading-relaxed">
                            I'm currently available for freelance projects and consulting. Whether you need help with
                            Laravel development, process automation, or building a SaaS product, I'd love to hear from
                            you.
                        </p>
