...
(function() {
    ...
    function generate() {
        ...
        if (!text.trim()) {
            showError('Please enter some text to glitch.');
            textOutput.value = '';
    ...
    btnCopy.addEventListener('click', function() {
        ...
        if (!output) {
            showError('Nothing to copy. Generate glitch text first.');
            return;
        }
    ...
    btnDownload.addEventListener('click', function() {
        const output = textOutput.value;
        if (!output) {
            showError('Nothing to download. Generate glitch text first.');
            return;
        }
        ...
        showSuccess('Downloaded glitch-text.txt');
    });
