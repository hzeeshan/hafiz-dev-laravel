...
<div class="mb-6 p-4 bg-darkBg rounded-lg border border-gold/10">
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div>
            <label for="json-indent" class="text-light font-semibold mb-2 block text-sm">{{ __($t . '.json_indentation') }}</label>
        ...
        <div>
            <label for="attr-prefix" class="text-light font-semibold mb-2 block text-sm">{{ __($t . '.attribute_prefix') }}</label>
...
<div id="stats-bar" class="hidden bg-darkBg rounded-lg p-4 border border-gold/10 mb-6">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="text-center">
            ...
            <div class="text-light-muted text-sm">{{ __($t . '.elements') }}</div>
        </div>
        <div class="text-center">
