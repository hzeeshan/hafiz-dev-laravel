...
<div id="results-section" class="hidden">
    ...
    <div class="bg-darkBg rounded-lg p-4 border border-gold/10 mb-4">
        ...
        <div class="space-y-2 text-sm">
            ...
            <div class="flex justify-between">
                <span class="text-light-muted">{{ __($t . '.breakdown_after_second') }}</span>
                <span class="text-light font-mono" id="breakdown-after-d2">$0.00</span>
            </div>
            <div class="flex justify-between">
                <span class="text-light-muted">{{ __($t . '.breakdown_third_discount') }} (<span id="breakdown-d3-pct">0%</span>)</span>
            ...
            <div class="border-t border-gold/10 pt-2 flex justify-between font-semibold">
                <span class="text-light">{{ __($t . '.breakdown_after_all') }}</span>
