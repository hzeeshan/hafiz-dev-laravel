...
<div class="mb-6 p-4 bg-darkBg rounded-lg border border-gold/10">
    ...
    <div class="flex flex-wrap gap-6">
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.null_safety') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.final_props') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.generate_from_json') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.generate_to_json') }}</span>
        </label>
        <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-sm text-light-muted">{{ __($t . '.generate_copy_with') }}</span>
        </label>
    </div>
</div>
...
<div class="grid lg:grid-cols-2 gap-4 mb-6">
    ...
    <div class="flex flex-col">
        ...
        <textarea
            ...
            placeholder="{{ __($t . '.dart_output_placeholder') }}"
            readonly
        ></textarea>
    </div>
</div>
...
<div id="stats-bar" class="hidden bg-darkBg rounded-lg p-4 border border-gold/10">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="text-center">
            ...
            <div class="text-light-muted text-sm">{{ __($t . '.classes') }}</div>
        </div>
        <div class="text-center">
        ...
        <div class="text-center">
            ...
            <div class="text-light-muted text-sm">{{ __($t . '.nested_classes') }}</div>
        </div>
        <div class="text-center">
