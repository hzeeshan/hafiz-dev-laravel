<x-layout>
    <x-slot:title>Triple Discount Calculator - Free Online Discount Calculator | hafiz.dev</x-slot:title>
    <x-slot:description>Free online triple discount calculator. Apply three successive discounts to any price and see the final price, total savings, and combined discount percentage instantly. No signup required.</x-slot:description>
    <x-slot:keywords>triple discount calculator, three discounts calculator, successive discount calculator, combined discount calculator, stacked discount calculator, multiple discount calculator, free discount calculator online, 3 discounts calculator</x-slot:keywords>
    <x-slot:canonical>{{ url('/tools/triple-discount-calculator') }}</x-slot:canonical>

    {{-- Open Graph --}}
    <x-slot:ogTitle>Triple Discount Calculator - Free Online Discount Calculator | hafiz.dev</x-slot:ogTitle>
    <x-slot:ogDescription>Apply three successive discounts to any price and see the final price, total savings, and combined discount percentage instantly. Free online calculator.</x-slot:ogDescription>
    <x-slot:ogType>website</x-slot:ogType>
    <x-slot:ogUrl>{{ url('/tools/triple-discount-calculator') }}</x-slot:ogUrl>
    ...
    @push('schemas')
        <script type="application/ld+json">
        {
            ...
            "name": "Triple Discount Calculator",
            "description": "Calculate the final price after applying three successive discounts. See total savings, combined discount percentage, and step-by-step breakdown.",
            "url": "https://hafiz.dev/tools/triple-discount-calculator",
        ...
        <script type="application/ld+json">
        {
            ...
            "itemListElement": [
                ...
                { "@@type": "ListItem", "position": 3, "name": "Triple Discount Calculator", "item": "https://hafiz.dev/tools/triple-discount-calculator" }
            ]
        }
        </script>
        <script type="application/ld+json">
        {
            ...
            "mainEntity": [
                {
                    "@@type": "Question",
                    "name": "How do you calculate a triple discount?",
                    "acceptedAnswer": {
                        "@@type": "Answer",
                        "text": "To calculate a triple discount, apply each discount sequentially to the reduced price. For example, with a $100 item and discounts of 20%, 10%, and 5%: first discount gives $80, second gives $72, third gives $68.40. The combined discount is 31.6%, not 35%."
                    }
                },
                {
                    "@@type": "Question",
                    "name": "Is a 20% + 10% + 5% discount the same as 35% off?",
                    "acceptedAnswer": {
                        "@@type": "Answer",
                        "text": "No. Three successive discounts of 20%, 10%, and 5% give a combined discount of 31.6%, not 35%. Each subsequent discount is applied to the already-reduced price, so you save less than if all percentages were simply added together."
                    }
                },
                {
                    "@@type": "Question",
                    "name": "Does the order of three discounts matter?",
                    "acceptedAnswer": {
                        "@@type": "Answer",
                        "text": "No, the order does not affect the final price. Applying 20% then 10% then 5% gives the same result as any other order. Mathematically, multiplying by 0.8, 0.9, and 0.95 in any order produces the same result because multiplication is commutative."
                    }
                },
                {
                    "@@type": "Question",
                    "name": "What is the combined discount formula for three discounts?",
                    "acceptedAnswer": {
                        "@@type": "Answer",
                        "text": "The combined discount formula is: Combined = 1 - (1 - d1/100) x (1 - d2/100) x (1 - d3/100), where d1, d2, and d3 are the discount percentages. For 20%, 10%, and 5%: 1 - (0.8 x 0.9 x 0.95) = 1 - 0.684 = 0.316, or 31.6%."
                    }
                },
                {
                    "@@type": "Question",
                    "name": "When would I use a triple discount calculator?",
                    "acceptedAnswer": {
                        "@@type": "Answer",
                        "text": "A triple discount calculator is useful when stores offer multiple stacked promotions, such as a seasonal sale plus a coupon plus a loyalty discount. It helps during events like Black Friday, where multiple offers combine. It shows you the true savings compared to what the percentages might suggest."
                    }
                }
            ]
        }
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <nav class="mb-6 text-sm" aria-label="Breadcrumb">
                <ol class="flex items-center gap-2 text-light-muted">
                    ...
                    <li><span class="text-gold/50">/</span></li>
                    <li class="text-gold">Triple Discount Calculator</li>
                </ol>
            </nav>

            {{-- Header --}}
            <div class="text-center mb-10">
                <h1 class="text-3xl md:text-4xl font-bold text-light mb-4">Triple Discount Calculator</h1>
            ...
            <div class="bg-gradient-card rounded-xl border border-gold/20 shadow-dark-card p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    {{-- Third Discount --}}
                    <div>
                        <label for="input-discount3" class="text-light font-semibold mb-2 flex items-center gap-2">
                            <svg class="w-4 h-4 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
                            3rd Discount (%)
                        </label>
                        <div class="relative">
                            <input type="number" id="input-discount3" step="0.01" min="0" max="100" placeholder="5"
                                class="w-full bg-darkBg border border-gold/20 rounded-lg px-4 pr-10 py-3 text-light font-mono placeholder:text-light-muted/40 focus:border-gold focus:outline-none focus:ring-1 focus:ring-gold/30 transition-colors">
                            <span class="absolute right-4 top-1/2 -translate-y-1/2 text-gold font-semibold">%</span>
                        </div>
                    </div>
                ...
                <div id="results-section" class="hidden">
                    ...
                    <div class="bg-darkBg rounded-lg p-4 border border-gold/10 mb-4">
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <div class="flex justify-between">
                                <span class="text-light-muted">Price after second discount</span>
                                <span class="text-light font-mono" id="breakdown-after-d2">$0.00</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-light-muted">Third discount (<span id="breakdown-d3-pct">0%</span>)</span>
                                <span class="text-green-400 font-mono" id="breakdown-d3-amount">-$0.00</span>
                            </div>
                            <div class="border-t border-gold/10 pt-2 flex justify-between font-semibold">
                                <span class="text-light">Price after all discounts</span>
                                <span class="text-gold font-mono" id="breakdown-after-d3">$0.00</span>
                            </div>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-12">
                <div class="bg-gradient-card p-6 rounded-xl border border-gold/20 shadow-dark-card">
                    ...
                    <h3 class="text-lg font-semibold text-light mb-2">Three Successive Discounts</h3>
                    <p class="text-light-muted text-sm">Apply three discounts one after the other and see the true combined discount. Learn why adding percentages gives the wrong answer.</p>
                </div>
                <div class="bg-gradient-card p-6 rounded-xl border border-gold/20 shadow-dark-card">
                    <div class="text-gold text-2xl mb-3">📊</div>
                ...
                <div class="space-y-4 max-w-3xl mx-auto">
                    <details class="group">
                        <summary class="flex items-center justify-between cursor-pointer p-4 bg-darkBg rounded-lg border border-gold/10 hover:border-gold/30 transition-colors">
                            <span class="text-light font-medium">How do you calculate a triple discount?</span>
                    ...
                    <details class="group">
                        <summary class="flex items-center justify-between cursor-pointer p-4 bg-darkBg rounded-lg border border-gold/10 hover:border-gold/30 transition-colors">
                            <span class="text-light font-medium">Why is 20% + 10% + 5% not the same as 35% off?</span>
                            <svg class="w-5 h-5 text-gold transform group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </summary>
                        <div class="p-4 text-light-muted text-sm leading-relaxed">
                    ...
                    <details class="group">
                        <summary class="flex items-center justify-between cursor-pointer p-4 bg-darkBg rounded-lg border border-gold/10 hover:border-gold/30 transition-colors">
                            <span class="text-light font-medium">Does the order of three discounts matter?</span>
                            <svg class="w-5 h-5 text-gold transform group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </summary>
                        <div class="p-4 text-light-muted text-sm leading-relaxed">
                    ...
                    <details class="group">
                        <summary class="flex items-center justify-between cursor-pointer p-4 bg-darkBg rounded-lg border border-gold/10 hover:border-gold/30 transition-colors">
                            <span class="text-light font-medium">What is the combined discount formula for three discounts?</span>
                            <svg class="w-5 h-5 text-gold transform group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </summary>
                        <div class="p-4 text-light-muted text-sm leading-relaxed">
                            The combined discount formula for three successive discounts (d1, d2, d3) is: <strong>Combined = 1 - (1 - d1/100) x (1 - d2/100) x (1 - d3/100)</strong>. For 20%, 10%, and 5%: 1 - (0.80 x 0.90 x 0.95) = 1 - 0.684 = 0.316, or 31.6%. This formula always gives a result less than the simple sum of the three discounts.
                        </div>
                    </details>
                    <details class="group">
                        <summary class="flex items-center justify-between cursor-pointer p-4 bg-darkBg rounded-lg border border-gold/10 hover:border-gold/30 transition-colors">
                            <span class="text-light font-medium">When would I use a triple discount calculator?</span>
                            <svg class="w-5 h-5 text-gold transform group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </summary>
                        <div class="p-4 text-light-muted text-sm leading-relaxed">
    ...
    @push('scripts')
        @include('tools.partials.triple-discount-calculator-script')
    @endpush
</x-layout>
